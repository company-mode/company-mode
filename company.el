...
Each function is called with the return value of the previous one.  The
first one gets passed the list of candidates, already sorted and without
duplicates (candidates with different annotations are considered to be
distinct)."
  :type '(choice
          (const :tag "None" nil)
